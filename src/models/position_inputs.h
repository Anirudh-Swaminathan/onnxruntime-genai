...
struct Qwen2VLPositionInputs : PositionInputs {
 ...
 private:
  ...
  // {rope_rank_, batch_size, sequence_length}. rope_rank_ is 3 (temporal/height/width) for Qwen2-VL /
  // Qwen3-VL, or 4 for Qwen3.5 (a leading text-position row), read from the decoder's position_ids input.
